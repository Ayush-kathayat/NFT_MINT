...
const totalNFT = []; // a array which will store the abject thatis "NFT"
...
mintNFT("Ayush" , "common" , "Prototype Edition" , "Brown" , "NIKA");       //  FIRST ELEMENT IN THE ARRAY OR THE FIRST OBJECT

mintNFT("Sutirtho" , "Epic" , "Special edition" , "Brown" , "KIKA");      //   SECOND ELEMENT IN THE ARRAY OR THE SECOND OBJECT

mintNFT("Rohit" , "Legendary" , "Limited edition" , "Brown" , "PIKA");      //   THIRD ELEMENT IN THE ARRAY OR THE THIRD OBJECT

mintNFT("Shashi" , "Uncommom" , "Variant Edition" , "Brown" , "DIKA");      //   FOURTH ELEMENT IN THE ARRAY OR THE FOURTH OBJECT

mintNFT("Om" , "Rare" , "Artist Proof" , "Brown" , "SIKA");      //    FIFTH ELEMENT IN THE ARRAY OR THE FIFTH OBJECT
